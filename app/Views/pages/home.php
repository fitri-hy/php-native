      ...
      <div class="grid md:grid-cols-2 gap-12 items-center">
        <div class="text-center md:text-left">
          ...
          <div class="grid grid-cols-4 gap-4 max-w-md mx-auto md:mx-0 mb-10">
            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <div class="text-center font-bold">Freedom</div>
            </div>
            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <div class="text-center font-bold">Easy</div>
            </div>
            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <div class="text-center font-bold">Fast</div>
            </div>
            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <div class="text-center font-bold">Pure</div>
            </div>
          </div>
          
          <div class="max-w-md mx-auto md:mx-0">
            <div class="flex flex-col sm:flex-row gap-3">
              <div class="text-purple-100 flex-grow px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 bg-white/10 backdrop-blur-sm border border-white/20">
				npx create-php-native
			  </div>
              <a href="https://github.com/fitri-hy/php-native" target="_blank" class="flex gap-2 px-6 font-bold py-3 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 rounded-lg transition-all duration-200 whitespace-nowrap">
        ...
        <div class="hidden md:block">
          <div class="relative">
            ...
            <img src="/images/banner.png" alt="Illustration" class="relative z-10 mx-auto floating-slow">
          </div>
        </div>
      </div>
    </div>